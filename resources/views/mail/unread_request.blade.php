...
<body style="background-color:#bfbfbf">
    <div style="margin-left:12%;display: inline-block; width:90%; margin-top:20px">
        <div style="background-color:white;padding:20px;width:80%;overflow-x:auto;">
            <div align="center">
                <h2 style="font-family:'Russo One';margin-top: 0;margin-bottom:0;font-size:24px" id="headertitle">Request
                    Notification</h2>
                <hr style="margin-top: 0;margin-bottom:0;">
                <h2 style="font-family:'Orbitron';margin-top: 0;margin-bottom:0;font-size:18px">TCD Portal</h2>
            </div>
            <h3 style="font-family:'Dosis'">{!! $content !!}</h3>
            {{-- <a href="{{ $email_link }}" class="btn col-md-4"
                style="text-decoration:none;color:white;background-color:#61615c;padding:5px 5px 5px 5px;"
                align="center">View More Information</a><br> --}}
            <hr style="margin-top: 10px;margin-bottom:0;">
            <center>
                <h5 style="margin-top: 0;margin-bottom:0;">** This is a system generated message. DO NOT REPLY TO THIS
                    EMAIL. **</h5>
