...
<body style="background-color:#bfbfbf">
  <div style="margin-left:12%;display: inline-block; width:90%; margin-top:20px">
    <div style="background-color:white;padding:20px;width:80%;overflow-x:auto;">
      ...
      <a href="{{ $info }}" class="btn col-md-4" style="text-decoration:none;color:white;background-color:#61615c;padding:5px 5px 5px 5px;" align="center">View More Information</a><br>
